		...
		CREATE TABLE V2_IMAGE_STREAM ()
			...
			CREATION_DATE          DATE DEFAULT  SYSDATE NOT NULL,
			MODIFIED_DATE          DATE DEFAULT  SYSDATE NOT NULL,
			 CONSTRAINT V2_IMAGE_STREAM_PK PRIMARY KEY (EXTERNAL_ID)
		;
		
		CREATE INDEX V2_IMAGE_STREAM_OBJ_IDX ON V2_IMAGE_STREAM( TARGET_OBJECT_TYPE, TARGET_OBJECT_ID ) ;	
