...
public class PageDisplayAction extends FrameworkActionSupport {

	public PageDisplayAction() {
	}

	private static final String DEFAULT_TEMPLATE = "/html/subpage.ftl" ;		
	protected String NOT_FOUND = "page-not-found";	
	...
	public String execute() throws Exception {						
		...
		if(StringUtils.isNotEmpty( pageToUse.getProperty("template", null) ) ){
			this.template = pageToUse.getProperty("template", null);
		}
		return success();
	}
