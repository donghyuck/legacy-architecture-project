...
public class DynamicSqlNode implements SqlNode {
	...
	/**
	 * 다이나믹 구현은 Freemarker 을 사용하여 처리한다. 따라서 나이나믹 처리를 위해서는 
	 * 반듯이 freemarker 의  규칙을 사용하여야 한다. 
	 * 
	 * 
	 */
	public boolean apply(DynamicContext context) {		
		...
		if( parameterObject != null ){
		    ...
		    {
		        map.put("params", ((MapSqlParameterSource)parameterObject).getValues());
    ...
    protected static void populateStatics(Map<String, Object> model){        
        ...
        //try
        //{            
            //model.put("ApplicationConstants", staticModels.get("architecture.ee.application.ApplicationConstants") );
           // model.put("LocaleUtils", staticModels.get("architecture.ee.util.LocaleUtils") );
            ...
            //model.put("Permissions", staticModels.get("architecture.ee.security.Permissions") );
