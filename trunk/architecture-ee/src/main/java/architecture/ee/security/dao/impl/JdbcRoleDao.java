package architecture.ee.security.dao.impl;
...
import architecture.ee.model.internal.RoleModelImpl;
...
public class JdbcRoleDao extends ExtendedJdbcDaoSupport implements  RoleDao {
	...
	public void deleteRole(long roleId) {
		getExtendedJdbcTemplate().update(getBoundSql("FRAMEWORK_V2.DELETE_GROUP_ROLES").getSql(), new Object[]{roleId}, new int[]{Types.INTEGER});
		getExtendedJdbcTemplate().update(getBoundSql("FRAMEWORK_V2.DELETE_USER_ROLES").getSql(), new Object[]{roleId}, new int[]{Types.INTEGER});
		getExtendedJdbcTemplate().update(getBoundSql("FRAMEWORK_V2.DELETE_ROLE").getSql(), new Object[]{roleId}, new int[]{Types.INTEGER});
	}
	...
	public List<Long> getAllRoleIds() {
		return getExtendedJdbcTemplate().queryForList(getBoundSql("FRAMEWORK_V2.SELECT_ALL_ROLE_IDS").getSql(), 
				Long.class );
	}

	public List<Long> getRoleIds(int start, int num) {
		return getExtendedJdbcTemplate().queryScrollable(getBoundSql("FRAMEWORK_V2.SELECT_ALL_ROLE_IDS").getSql(), 
