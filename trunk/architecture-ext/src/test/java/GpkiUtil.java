...
public class GpkiUtil {
	...
	public void init() throws Exception {
		...
		System.out.println("Loading gpki certificate : myServerId=" + this.getMyServerId());
		...
		this.finish(gpki);
		System.out.println("GpkiUtil initialized\n");
	}

	private void load(gpkiapi_jni gpki, String certId) throws Exception {

		System.out.println("Loading gpki certificate : targetServerId="	+ certId);
		...
		if (isLDAP) {
			...
			if(certFilePath != null){
				...
				System.out.println("not certFilePath");
			}
		}
