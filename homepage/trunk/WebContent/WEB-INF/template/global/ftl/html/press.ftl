			...
			complete: function() {
				...
				$("#topic-grid").kendoGrid({
					...
					columns: [
						...
						{field: "subject", title: "제목", sortable : false, template: '<span class="label label-primary label-lightweight rounded">#= $.timeago(modifiedDate)  #</span><span class="overflow-h"> #: subject # </span>' },						
