							...
							<div class="details-content">				
									<div class="panel panel-transparent">
										<div class="panel-heading">
											...
											<div class="btn-group">
												<button type="button" class="btn btn-info btn-sm btn-flat btn-control-group" data-action="upload-logo"><i class="fa fa-upload"></i> 로고 변경</button>
												<button type="button" class="btn btn-info btn-sm btn-flat btn-control-group" data-action="role"><i class="fa fa-pencil"></i> 정보변경</button>
											</div>	
