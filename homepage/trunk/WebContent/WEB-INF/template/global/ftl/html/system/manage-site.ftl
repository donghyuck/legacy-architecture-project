								...
								<div class="panel panel-transparent">
									<div class="panel-heading">
										...
										<div class="panel-heading-controls">
											...
											<div class="btn-group">
												<button type="button" class="btn btn-success btn-sm btn-flat btn-control-group" data-action="upload-logo" data-toggle="button" data-bind="enabled: isEnabled, click:toggleLogoUploadPanel"><i class="fa fa-upload"></i> 로고 업로드</button>
