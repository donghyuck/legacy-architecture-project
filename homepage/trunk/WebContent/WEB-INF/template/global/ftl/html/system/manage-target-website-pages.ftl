			...
			if(!$("#website-page-grid").data('kendoGrid') ){
				...
				$("#website-page-grid").kendoGrid({
                    ...
                    columns: [
                        ...
                        { field: "pageState", title: "상태", width: 120, headerAttributes: { "class": "table-header-cell", style: "text-align: center" }, template: '<span class="label label-success">#: pageState #</span>'},
				...
				<div class="row">	
					...
					<div  id="page-editor-panel" class="panel panel-default" style="min-height:300px; display:none;">	
						<div class="panel-heading">
							...
							<button type="button" class="close btn-control-group" data-action="page-editor-close">&times;  <h6><small>닫기</small></h6></button>
						</div>
