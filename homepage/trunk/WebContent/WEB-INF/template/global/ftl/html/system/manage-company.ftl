			...
			complete: function() {
				...
				var company_grid = $("#company-grid").kendoGrid({
					...
					columns: [
						...
						{ field: "name",    title: "KEY",  filterable: true, sortable: true,  width: 100, template: '<button type="button" class="btn btn-warning btn-xs btn-block" onclick="showCompanyDetails(); return false;">#: name #</a>' }, 
