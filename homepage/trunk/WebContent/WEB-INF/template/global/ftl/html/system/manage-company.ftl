					...
					<div class="col-sm-12">					
						<div class="panel panel-default" style="min-height:300px;">
							<div class="panel-heading">
								...
								한글	| <button class="btn btn-danger btn-sm btn-labeled btn-control-group" data-action="create-company"><span class="btn-label icon fa fa-plus"></span> 회사 만들기 </button>
								</div>
							</div>
