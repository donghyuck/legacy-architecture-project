						...
						<div class="panel panel-default" style="min-height:300px;">
							...
							<div class="panel-heading-controls">
								<div class="btn-group">
									...
									<button type="button" class="btn btn-info btn-control-group btn-sm" data-action="role"><i class="fa fa-lock"></i> 권한 & 롤</button>
								</div>
								<div class="btn-group">
									<button type="button" class="btn btn-success btn-control-group btn-sm" data-action="group"><i class="fa fa-users"></i> 그룹관리</button>
									<button type="button" class="btn btn-success btn-control-group btn-sm" data-action="user"><i class="fa fa-user"></i> 사용자관리</button>
								</div>
								<button type="button" class="btn btn-default btn-control-group btn-sm btn-columns-expend" data-action="layout"><i class="fa fa-columns"></i></button>					
							</div>
							</div>
