			...
			complete: function() {               
				...
				common.ui.admin.setup({
					...
					companyChanged: function(item){
						...
						kendo.bind($("#company-info"), detailsModel );				
								...
								<div class="col-lg-5 col-xs-12" id="site-info">					
									<div class="page-header page-nounderline-header text-primary">
										...
										<p class="pull-right">
											...
											<button type="button" class="btn btn-success btn-control-group btn-sm" data-toggle="button" data-action="timeline" disabled="disabled"><i class="fa fa-clock-o"></i> 웹사이트 타임라인</button>
										</p>
									</div>										
									<table class="table">
											<tbody>						
