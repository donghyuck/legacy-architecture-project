								...
								<div class="panel panel-transparent">
										<div class="panel-heading">
											...
											<div class="panel-heading-controls">
												...
												<div class="btn-group">
													<button type="button" class="btn btn-success btn-flat btn-control-group" data-action="upload-logo" data-toggle="button" data-bind="enabled: isEnabled, click:toggleOptionPanel"><i class="fa fa-sitemap"></i> 매뉴변경</button>
