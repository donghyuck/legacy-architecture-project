	...
	<body>
		...
		<div class="jumbotron jumbotron-ad hidden-print jumbotron-page-header">
		  <div class="container">
		    ...
		    <h4><small class="text-muted"><i class="fa fa-quote-left fa-2x pull-left"></i>${action.targetContent.summary?replace("#company#", action.user.company.displayName ) }<i class="fa fa-quote-right"></i></small></h4>
		  </div>
		</div>			
