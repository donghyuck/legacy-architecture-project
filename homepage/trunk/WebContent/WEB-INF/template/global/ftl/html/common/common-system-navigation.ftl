			...
			<div id="main-menu-inner">
				...
				<#list menu.components as item >
					...
					<li class="mm-dropdown">
						<a href="javascript:void(0);" data-menu-item="${item.name}"> <#if item.isSetIcon()><i class="menu-icon fa ${item.icon}"></i><#else><i class="menu-icon fa fa-folder-o"></i>s</#if><span class="mm-text">${item.title}</span></a>
						<ul>
