		...
		yepnope([{
			...
			*/
			...
			complete: function() {
				...
				var template = kendo.template('<li class="overflow-hidden"><i class="fa fa-check color-green"></i> <a href="\\#">#:subject#</a> #if( typeof viewCnt == "number") {#<small class="hex">(#: viewCnt #)</small>#}#</li>');
