        ...
        <div id="layerslider-container-fw">        
            <div id="layerslider" style="width: 100%; height: 450px; margin: 0px auto; ">
                ...
                <div class="ls-layer" data-ls="transition2d:93;">
					...
					<img src="http://img.inkium.com/homepage/slider/main_consulting_01" alt="Slider Image" 
               		 ...
               		 <img src="http://img.inkium.com/homepage/slider/main_consulting_02" alt="Slider Image" 
               		 	class="ls-s-2" 
               		 	style=" top:0px; left: 740px; slidedirection : left; slideoutdirection : right; durationin : 2500; durationout : 1500; ">
               		 <img src="http://img.inkium.com/homepage/slider/main_O.png" alt="Slider Image" class="ls-s-1" style=" top:10px; left: 990px; slidedirection : right; slideoutdirection : bottom; durationin : 2000; durationout : 1500; ">
                </div>
                <!--End Second Slide-->
                <!--Third Slide-->
                ...
                <div class="ls-layer" style="slidedirection: right; transition2d: 92,93,105">
		           ...
		           <i class="fa fa-chevron-circle-right ls-s-1" style=" color: #fff; font-size: 22px; top:50px; left: 40px; slidedirection : left; slideoutdirection : top; durationin : 1500; durationout : 500; "></i>
		            <span class="ls-s-2" style=" color: #fff; font-weight: 200; font-size: 20px; top:50px; left: 70px; slidedirection : top; slideoutdirection : bottom; durationin : 1500; durationout : 500; ">
		                직업능력개발원 공식 민간 PT전문자격증!
		            </span>		
		            <i class="fa fa-chevron-circle-right ls-s-1" style=" color: #fff; font-size: 22px; top:100px; left: 40px; slidedirection : left; slideoutdirection : top; durationin : 2500; durationout : 1500; "></i> 		
		            <span class="ls-s-2" style=" color: #fff; font-weight: 200; font-size: 20px; top:100px; left: 70px; slidedirection : top; slideoutdirection : bottom; durationin : 2500; durationout : 1500; ">
		               대학생의 취업을 위한 발표 능력 UP!
		            </span>		
		            <i class="fa fa-chevron-circle-right ls-s-1" style=" color: #fff; font-size: 22px; top:150px; left: 40px; slidedirection : left; slideoutdirection : top; durationin : 3500; durationout : 3500; "></i>		
		            <span class="ls-s-2" style=" color: #fff; font-weight: 200; font-size: 20px; top:150px; left: 70px; slidedirection : top; slideoutdirection : bottom; durationin : 3500; durationout : 2500; ">
		               직장인의 보고능력, 수주를 위한 프레젠테이션 능력 UP!
		            </span>					
					
					<span class="ls-s-1" style=" color: #fff; line-height:55px; font-weight: bold; font-size: 28px; top:175px; left: 40px; slidedirection : top; slideoutdirection : bottom; durationin : 4500; durationout : 1000; ">
                      전문자격시험<br> 
					...
					<img src="http://img.inkium.com/homepage/slider/main_contents_01.png" alt="Slider Image" 
						class="ls-s-1" 
						style=" top:0px; left: 490px; slidedirection : top; slideoutdirection : bottom; durationin : 1000; durationout : 1500; ">
               		 <img src="http://img.inkium.com/homepage/slider/main_contents_02.png" alt="Slider Image" 
               		 	class="ls-s-2" 
               		 	style=" top:200px; left: 850px; slidedirection : left; slideoutdirection : up; durationin : 1500; durationout : 1500; ">
               		 <img src="http://img.inkium.com/homepage/slider/main_O.png" alt="Slider Image" class="ls-s-1" style=" top:10px; left: 990px; slidedirection : right; slideoutdirection : bottom; durationin : 1000; durationout : 1500; ">
