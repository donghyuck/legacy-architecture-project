...
<style>
	...
	header.cloud {
		...
		*/
		background: 
		linear-gradient(63deg, #bdc3c7 23%, transparent 23%) 7px 0, 
		linear-gradient(63deg, transparent 74%, #bdc3c7 78%), 
		linear-gradient(63deg, transparent 34%, #bdc3c7 38%, #bdc3c7 58%, transparent 62%), 
		#ecf0f1;
