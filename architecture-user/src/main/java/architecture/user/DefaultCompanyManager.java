...
public class DefaultCompanyManager extends AbstractCompanyManager {
	...
	if (original == null)
	    throw CodeableException.newException(CompanyAlreadyExistsException.class, 5141, company.getCompanyId()); // new
	...
	if (!nameEquals(original, company)) {
		...
		if (checked.getCompanyId() == company.getCompanyId()) {
		    throw CodeableException.newException(CompanyAlreadyExistsException.class, 5143); // new
	...
	if (g == null)
	    throw CodeableException.newException(CompanyNotFoundException.class, 5142, name);// new
	...
	if (foundCompany == null)
	    throw CodeableException.newException(CompanyNotFoundException.class, 5141, companyId); // new
												   // GroupNotFoundException((new
												   // StringBuilder()).append("No
												   // group
												   // found
