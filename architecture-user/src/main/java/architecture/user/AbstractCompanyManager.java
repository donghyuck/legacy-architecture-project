...
public abstract class AbstractCompanyManager implements CompanyManager, EventSource {
    ...
    /**
     * @param companyDomainCache
     *            설정할 companyDomainCache
     */
    ...
    // protected abstract Company lookupCompanyByDomainName(String name) throws
	...
	return c1.getName() != null && c2.getName() != null
		&& caseCompanyName(c1.getName()).equals(caseCompanyName(c2.getName()));
    }
