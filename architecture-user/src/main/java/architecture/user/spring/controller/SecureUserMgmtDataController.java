...
public class SecureUserMgmtDataController {
    ...
    @ResponseBody
    public Result createCompany(@RequestBody CompanyTemplate newCompany, NativeWebRequest request)
	    throws CompanyAlreadyExistsException {

	User user = SecurityHelper.getUser();
	companyManager.createCompany(newCompany.getName(), newCompany.getDisplayName(), newCompany.getDomainName(),
	...
	if (companyId > 0) {
		...
		if (company.getCompanyId() == group.getCompanyId()) {
		    ...
		    if (pageSize > 0) {
			list = userManager.findUsersWithGroupFilter(company, group, nameOrEmailToUse, startIndex,
				pageSize);
		    } else {
    ...
    @ResponseBody
    public Result updateGroupPropertyList(@RequestBody StringProperty[] newProperties,
	    @RequestParam(value = "groupId", defaultValue = "0", required = true) Long groupId,
    ...
    @ResponseBody
    public Result deleteGroupPropertyList(@RequestBody StringProperty[] newProperties,
	    @RequestParam(value = "groupId", defaultValue = "0", required = true) Long groupId,
	    NativeWebRequest request) throws GroupNotFoundException, GroupAlreadyExistsException {
    ...
    @RequestMapping(value = "/mgmt/group/roles/list_with_ownership.json", method = { RequestMethod.POST,
	    RequestMethod.GET })
    @ResponseBody
    ...
    @ResponseBody
    public Result addGroupRole(@RequestParam(value = "groupId", defaultValue = "0", required = true) Long groupId,
	    @RequestParam(value = "roleId", defaultValue = "0", required = true) Long roleId, NativeWebRequest request)
    ...
    @ResponseBody
    public Result removeGroupRole(@RequestParam(value = "groupId", defaultValue = "0", required = true) Long groupId,
	    @RequestParam(value = "roleId", defaultValue = "0", required = true) Long roleId, NativeWebRequest request)
	    throws RoleNotFoundException, GroupNotFoundException {
    ...
    @ResponseBody
    public Result updateGroupRoles(@RequestBody List<DefaultRole> newRoles,
	    @RequestParam(value = "groupId", defaultValue = "0", required = true) Long groupId,
	    NativeWebRequest request) throws UserNotFoundException, GroupNotFoundException {
    ...
    @ResponseBody
    public ItemList getGroupUsers(@RequestParam(value = "groupId", defaultValue = "0", required = true) Long groupId,
	    @RequestParam(value = "startIndex", defaultValue = "0", required = false) Integer startIndex,
	    @RequestParam(value = "pageSize", defaultValue = "0", required = false) Integer pageSize,
	    NativeWebRequest request) throws GroupNotFoundException {
	Group group = groupManager.getGroup(groupId);
    ...
    @ResponseBody
    public Result addGroupMemberships(@RequestParam(value = "userIds[]", required = true) Long[] userIds,
	    @RequestParam(value = "groupId", defaultValue = "0", required = true) Long groupId,
	    NativeWebRequest request) throws UserNotFoundException, GroupNotFoundException {
    ...
    @ResponseBody
    public Result removeGroupMemberships(@RequestParam(value = "userIds[]", required = true) Long[] userIds,
	    @RequestParam(value = "groupId", defaultValue = "0", required = true) Long groupId,
	    NativeWebRequest request) throws UserNotFoundException, GroupNotFoundException {
    ...
    public List<Property> getUserPropertyList(
	    @RequestParam(value = "userId", defaultValue = "0", required = true) Long userId, NativeWebRequest request)
    ...
    @ResponseBody
    public Result updateUserPropertyList(@RequestBody StringProperty[] newProperties,
	    @RequestParam(value = "userId", defaultValue = "0", required = true) Long userId, NativeWebRequest request)
    ...
    @ResponseBody
    public Result deleteUserPropertyList(@RequestBody StringProperty[] newProperties,
	    @RequestParam(value = "userId", defaultValue = "0", required = true) Long userId, NativeWebRequest request)
	    throws UserNotFoundException, UserAlreadyExistsException {
    ...
    @ResponseBody
    public List<Group> getUserGroups(@RequestParam(value = "userId", defaultValue = "0", required = true) Long userId,
	    NativeWebRequest request) throws UserNotFoundException {
	User u = userManager.getUser(userId);
	return groupManager.getUserGroups(u);
    }

    @RequestMapping(value = "/mgmt/user/groups/list_with_membership.json", method = { RequestMethod.POST,
	    RequestMethod.GET })
    @ResponseBody
    ...
    @ResponseBody
    public Result addGroupMembership(@RequestParam(value = "userId", defaultValue = "0", required = true) Long userId,
	    @RequestParam(value = "groupId", defaultValue = "0", required = true) Long groupId,
	    NativeWebRequest request) throws UserNotFoundException, GroupNotFoundException {
	User user = userManager.getUser(userId);
	Group group = groupManager.getGroup(groupId);
    ...
    @RequestMapping(value = "/mgmt/user/roles/list_from_groups.json", method = { RequestMethod.POST,
	    RequestMethod.GET })
    @ResponseBody
    ...
    @ResponseBody
    public List<Role> getUserRoles(@RequestParam(value = "userId", defaultValue = "0", required = true) Long userId,
	    NativeWebRequest request) throws UserNotFoundException, GroupNotFoundException {
	User user = userManager.getUser(userId);
	return extractUserRoles(roleManager.getFinalUserRoles(user.getUserId()),
		roleManager.getUserRolesFromGroup(user.getUserId()));
    }

    @RequestMapping(value = "/mgmt/user/roles/list_with_ownership.json", method = { RequestMethod.POST,
	    RequestMethod.GET })
    @ResponseBody
    ...
    @ResponseBody
    public Result addUserRole(@RequestParam(value = "userId", defaultValue = "0", required = true) Long userId,
	    @RequestParam(value = "roleId", defaultValue = "0", required = true) Long roleId, NativeWebRequest request)
    ...
    @ResponseBody
    public Result removeUserRole(@RequestParam(value = "userId", defaultValue = "0", required = true) Long userId,
	    @RequestParam(value = "roleId", defaultValue = "0", required = true) Long roleId, NativeWebRequest request)
	    throws UserNotFoundException, RoleNotFoundException {
    ...
    @ResponseBody
    public Result updateUserRoles(@RequestBody List<DefaultRole> newRoles,
	    @RequestParam(value = "userId", defaultValue = "0", required = true) Long userId, NativeWebRequest request)
	    throws UserNotFoundException, GroupNotFoundException {
