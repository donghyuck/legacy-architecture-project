...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	http.authorizeRequests()
		...
		.logoutUrl("/accounts/logout").logoutSuccessUrl("/main.do").and().anonymous().key("ANONYMOUS").and()
		.exceptionHandling().accessDeniedPage("/includes/jsp/unauthorized.jsp").and().requestCache()
