...
public class JdbcRoleDao extends ExtendedJdbcDaoSupport implements RoleDao {
	...
	getExtendedJdbcTemplate().update(getBoundSql("ARCHITECTURE_SECURITY.CREATE_ROLE").getSql(),
		new Object[] { id, role.getName(), role.getMask(), role.getDescription(), role.getCreationDate(),
	...
	getExtendedJdbcTemplate().update(getBoundSql("ARCHITECTURE_SECURITY.DELETE_GROUP_ROLES").getSql(),
		new Object[] { roleId }, new int[] { Types.INTEGER });

	getExtendedJdbcTemplate().update(getBoundSql("ARCHITECTURE_SECURITY.DELETE_USER_ROLES").getSql(),
		new Object[] { roleId }, new int[] { Types.INTEGER });

	getExtendedJdbcTemplate().update(getBoundSql("ARCHITECTURE_SECURITY.DELETE_ROLE").getSql(),
		new Object[] { roleId }, new int[] { Types.INTEGER });
	...
	getExtendedJdbcTemplate().update(getBoundSql("ARCHITECTURE_SECURITY.UPDATE_ROLE").getSql(),
		new Object[] { role.getName(), role.getMask(), role.getDescription(), role.getModifiedDate(),
			role.getRoleId() },
	...
	Role role = getExtendedJdbcTemplate().queryForObject(
		getBoundSql("ARCHITECTURE_SECURITY.SELECT_ROLE_BY_ID").getSql(), new Object[] { roleId },
		new int[] { Types.INTEGER }, roleRowMapper);
	return role;
    }
	...
	Role role = getExtendedJdbcTemplate().queryForObject(
		getBoundSqlWithAdditionalParameter("ARCHITECTURE_SECURITY.SELECT_ROLE_BY_NAME", caseInsensitive)
			.getSql(),
	...
	getExtendedJdbcTemplate().update(getBoundSql("ARCHITECTURE_SECURITY.REMOVE_USER_ROLES").getSql(),
		new Object[] { userId }, new int[] { Types.INTEGER });
    }

    public void deleteGroupRoles(long groupId) {
	getExtendedJdbcTemplate().update(getBoundSql("ARCHITECTURE_SECURITY.REMOVE_USER_ROLES").getSql(),
		new Object[] { groupId }, new int[] { Types.INTEGER });
    }
	...
	return getExtendedJdbcTemplate().queryForList(getBoundSql("ARCHITECTURE_SECURITY.SELECT_ALL_ROLE_IDS").getSql(),
		Long.class);
    }

    public List<Long> getRoleIds(int start, int num) {
	return getExtendedJdbcTemplate().queryScrollable(
		getBoundSql("ARCHITECTURE_SECURITY.SELECT_ALL_ROLE_IDS").getSql(), start, num, new Object[0],
		new int[0], Long.class);
    }

    public List<Long> getUserRoleIds(long userId) {
	return getExtendedJdbcTemplate().queryForList(
		getBoundSql("ARCHITECTURE_SECURITY.SELECT_USER_ROLE_IDS").getSql(), new Object[] { userId },
		new int[] { Types.INTEGER }, Long.class);
    }

    public List<Long> getGroupRoleIds(long groupId) {
	return getExtendedJdbcTemplate().queryForList(
		getBoundSql("ARCHITECTURE_SECURITY.SELECT_GROUP_ROLE_IDS").getSql(), new Object[] { groupId },
		new int[] { Types.INTEGER }, Long.class);
    }

    public void removeUserRole(long roleId, long userId) {
	getExtendedJdbcTemplate().update(getBoundSql("ARCHITECTURE_SECURITY.DELETE_USER_ROLE").getSql(),
		new Object[] { roleId, userId }, new int[] { Types.INTEGER, Types.INTEGER });
    }

    public void removeGroupRole(long roleId, long groupId) {
	getExtendedJdbcTemplate().update(getBoundSql("ARCHITECTURE_SECURITY.DELETE_GROUP_ROLE").getSql(),
		new Object[] { roleId, groupId }, new int[] { Types.INTEGER, Types.INTEGER });
    }

    public void addUserRole(long roleId, long userId) {
	getExtendedJdbcTemplate().update(getBoundSql("ARCHITECTURE_SECURITY.CREATE_USER_ROLE").getSql(),
		new Object[] { roleId, userId }, new int[] { Types.INTEGER, Types.INTEGER });
    }

    public void addGroupRole(long roleId, long groupId) {
	getExtendedJdbcTemplate().update(getBoundSql("ARCHITECTURE_SECURITY.CREATE_GROUP_ROLE").getSql(),
		new Object[] { roleId, groupId }, new int[] { Types.INTEGER, Types.INTEGER });
    }
}