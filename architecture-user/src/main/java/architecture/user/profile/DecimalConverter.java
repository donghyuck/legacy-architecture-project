...
public class DecimalConverter extends SingleFieldMapper implements TypeConverter {

    public DecimalConverter() {
    }

    public Double convertFromString(String s) throws TypeConverter.ConversionException {
	try {
    ...
    public String convertToString(Double object) throws TypeConverter.ConversionException {
