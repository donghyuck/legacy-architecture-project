...
public class ProfileFieldValueCount {
	...
	public int compare(ProfileFieldValueCount o1, ProfileFieldValueCount o2) {
	    String val1 = o1.getValue() != null ? o1.getValue().getValue() != null ? o1.getValue().getValue() : "" : "";
	    String val2 = o2.getValue() != null ? o2.getValue().getValue() != null ? o2.getValue().getValue() : "" : "";
