...
public class BooleanConverter extends SingleFieldMapper implements TypeConverter {

    public BooleanConverter() {
    }

    public Boolean convertFromString(String s) throws TypeConverter.ConversionException {
	return Boolean.valueOf(s);
    }

    public String convertToString(Boolean object) throws TypeConverter.ConversionException {
