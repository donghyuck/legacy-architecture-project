...
public class EmailConverter extends BeanPropsExternalMapper implements TypeConverter {
    ...
    public EmailAddress convertFromString(String s) throws TypeConverter.ConversionException {
	...
	if (tokens.length == 1) {
	    ...
	    throw new TypeConverter.ConversionException((new StringBuilder()).append("Unable to convert '").append(s)
		    .append("' into an email address").toString());
	}
    }

    public String convertToString(EmailAddress object) throws TypeConverter.ConversionException {
    ...
    public String convertToString(Object obj) throws TypeConverter.ConversionException {
