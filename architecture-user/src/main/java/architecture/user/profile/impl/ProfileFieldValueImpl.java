...
public class ProfileFieldValueImpl implements ProfileFieldValue {
	...
	if (value != null)
	    throw new IllegalStateException(
		    "UserProfile has already been assigned a single value and can not be assigned a multilist of values as well.");
	...
	if (values != null) {
	    throw new IllegalStateException(
		    "UserProfile has already been assigned a multilist and can not be assigned a single value as well.");
	} else {
	    this.value = value;
	    return;
	}
    ...
    /**
     * public void setPrimaryValue(boolean isPrimaryValue) { this.isPrimaryValue
     * = isPrimaryValue; }
     */
	...
	if (getTypeConverter() == null)
	    throw new IllegalStateException((new StringBuilder())
		    .append("No valid type converter available for type id ").append(this.getFieldTypeId()).toString());
	else
	    return;
    }
	...
	if (values != null && useTo.values == null)
	    return false;
	return values == null || useTo.values == null
		|| values.containsAll(useTo.values) && useTo.values.containsAll(values);
    }
