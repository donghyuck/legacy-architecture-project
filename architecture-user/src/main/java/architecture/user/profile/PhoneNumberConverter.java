...
public class PhoneNumberConverter extends BeanPropsExternalMapper implements TypeConverter {

    public PhoneNumberConverter() {
	super(PhoneNumber.class);
    }

    public PhoneNumber convertFromString(String s) throws TypeConverter.ConversionException {
	...
	if (tokens.length == 1) {
	    ...
	    throw new TypeConverter.ConversionException((new StringBuilder()).append("Unable to convert '").append(s)
		    .append("' into a phone number").toString());
	}
    }

    public String convertToString(PhoneNumber object) throws TypeConverter.ConversionException {
