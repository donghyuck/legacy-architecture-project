...
public class IntegerConverter extends SingleFieldMapper implements TypeConverter {

    public IntegerConverter() {
    }

    public Integer convertFromString(String s) throws TypeConverter.ConversionException {
	try {
    ...
    public String convertToString(Integer object) throws TypeConverter.ConversionException {
