...
public class DateConverter extends SingleFieldMapper implements TypeConverter {
    ...
    public Date convertFromString(String s) throws TypeConverter.ConversionException {
	try {
	    return new Date(Long.parseLong(s));
	} catch (NumberFormatException e) {
	    throw new TypeConverter.ConversionException(
		    (new StringBuilder()).append("Unable to parse date with form: ").append(s).toString());
	}
    }

    public String convertToString(Date object) throws TypeConverter.ConversionException {
