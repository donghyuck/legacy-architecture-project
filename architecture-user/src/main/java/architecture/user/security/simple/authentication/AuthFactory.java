...
public class AuthFactory {
    ...
    public static AuthToken loginUserAndLoadProperties(String username, String password, boolean newSession,
    ...
    public static AuthToken loginUser(String username, String password, boolean newSession,
	    HttpServletRequest httpservletrequest, HttpServletResponse httpservletresponse)
