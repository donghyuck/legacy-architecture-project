...
/**
 * Represents a set of permissions that an entity has for an object in the
 * system. For example, the rights that a user has for a category. Permissions
 * are used by the protection proxy objects defined for each major component of
 * the system to provide access rights.
 * <p>
 * <p/>
 * A Permissions object is internally represented as a long with each bit
 * indicating whether a particular permission is set. The constants defined by
 * extensions of this class define the bit masks that can be used for permission
 * operations. For example, the following code creates permissions:
 * 
 * <pre>
* <p/>
...
* Permissions perms2 = new Permissions(Permissions.READ_FORUM | Permissions.SYSTEM_ADMIN);
 * </pre>
 * <p/>
 ...
 * <tt>0000000000000000000000000000000010000000000000000000000000000001</tt>.
 * <p>
 */
...
public class Permissions implements Serializable {
	...
	NONE(0L), VIEW_ONLINE_STATUS(0x100000000000000L), USER_ADMINISTRATION(0x200000000000000L), GROUP_ADMINISTRATION(
		0x400000000000000L), SYSTEM_ADMINISTRATION(0x800000000000000L), HOSTED_ADMINISTRATION(0x10000000L),

	READ_DOCUMENT(16384L), READ_COMMENT(0x10000L), CREATE_DOCUMENT(0x40000L), CREATE_COMMENT(
		0x100000L), CREATE_DOCUMENT_ATTACHMENT(0x200000L), CREATE_DOCUMENT_IMAGE(0x400000L), RATE_DOCUMENT(
			0x2000000L), CREATE_IMAGE(0x4000000L), CREATE_FILE(0x8000000L), CREATE_POLL(16L),

	VIEW_WEBSITE(1L), CREATE_MESSAGE(2L), MODERATOR(128L), WEBSITE_ADMIN(512L), VOTE_IN_POLL(
		1024L), CREATE_ANNOUNCEMENT(4096L);
