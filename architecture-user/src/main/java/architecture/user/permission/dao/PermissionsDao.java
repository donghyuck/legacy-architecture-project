...
public interface PermissionsDao {
    ...
    public abstract void removeGroupPerms(int objectType, long objectId, Group group, int permissionType,
	    int permission);
    ...
    public abstract void removeUserPerms(int objectType, long objectId, long userId, int permissionType,
	    int permission);
