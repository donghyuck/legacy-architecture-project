...
public interface GroupManager {
    ...
    public abstract Group createGroup(String name, String displayName, Company company)
	    throws GroupAlreadyExistsException;

    public abstract Group createGroup(String name, String displayName, String description, Company company)
	    throws GroupAlreadyExistsException;
    ...
    /*
     * 
     * public abstract Group getGroup(long groupId) throws
     * RoleNotFoundException;
     * 
     * public abstract Group getGroup(String name) throws RoleNotFoundException;
     * 
     * public abstract Group getGroup(long groupId, boolean flag) throws
     * RoleNotFoundException;
     * 
     * 
     * 
     * 
     * 
     * public abstract void updateGroup(Group group) throws
     * RoleNotFoundException, RoleAlreadyExistsException;
     * 
     * public abstract void deleteGroup(Group group) throws
