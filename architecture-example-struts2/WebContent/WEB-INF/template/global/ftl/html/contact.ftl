		...
		<header>
			<div class="container">
				<div class="col-lg-12">	
					...
					<h4><i class="fa fa-quote-left"></i>&nbsp; ${action.user.company.displayName} 를 찾아오시는 방법입니다.</h4>
				</div>
			</div>
		</header>	
		<!-- END HEADER -->	
			...
			<div class="row">
				<div class="col-lg-3 visible-lg">
					<div class="list-group">
					  ...
					  <a href="${request.contextPath}/contact.do" class="list-group-item active">오시는길</a>
					</div>					
				</div>
				<div class="col-lg-9">
