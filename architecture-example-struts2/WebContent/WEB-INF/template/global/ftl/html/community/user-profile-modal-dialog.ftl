	...
	<body>
		...
		<script type="text/x-kendo-template" id="social-network-list-view-template">
			<div class="panel panel-default margin-buttom-5">
				...
				# } else { # 
				<div class="btn-group">
				<button type="button" class="btn btn-default custom-social-network-account" data-loading-text="정보를 가져오는 중입니다." data-media="#: serviceProviderName#" data-account="#:socialAccountId#"><i class="fa fa-user"></i></button>
