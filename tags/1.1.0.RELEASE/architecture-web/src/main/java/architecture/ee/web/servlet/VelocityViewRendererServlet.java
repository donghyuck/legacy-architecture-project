...
public class VelocityViewRendererServlet extends ViewRendererServlet {

	public VelocityViewRendererServlet() {
		translator = new DefaultRequestToViewNameTranslator();
		viewResolverName = "velocityViewResolver";
	}
	...
	protected void renderView(HttpServletRequest httpservletrequest,
		...
		boolean enabled = WebApplicationHelper.getApplicationBooleanProperty(WebApplicatioinConstants.VIEW_VELOCITY_ENABLED, false);
		if( enabled )
