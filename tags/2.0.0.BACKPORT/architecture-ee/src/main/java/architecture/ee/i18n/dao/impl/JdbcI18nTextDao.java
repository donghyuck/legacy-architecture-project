...
/*
	class I18nTextRowMapper implements RowMapper<I18nText> {		
		public I18nText mapRow(ResultSet rs, int rowNum) throws SQLException {
			...
			impl.setObjectType(rs.getInt(2));
			impl.setObjectId(rs.getLong(3));
			impl.setObjectAttribute(rs.getInt(4));
			impl.setLocaleCode(rs.getString(5));
			impl.setText(rs.getString(6));
			impl.setCreationDate(rs.getDate(7));
			impl.setModifiedDate(rs.getDate(8));
			return impl;
		}};
