 ...
 * @author donghyuck
 */
public abstract class AbstractJdbcApplicationProperties extends ExtendedJdbcDaoSupport
    ...
    protected void firePropertyChangeEvent(Object source, ApplicationPropertyChangeEvent.Type eventType,
	    String propertyName, Object oldValue, Object newValue) {
	if (eventPublisher != null) {
	    eventPublisher
		    .publish(new ApplicationPropertyChangeEvent(source, eventType, propertyName, oldValue, newValue));
	}
    }
