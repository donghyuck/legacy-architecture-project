...
public class ExcelReader {
	...
	/*
	 * if(inputStream.markSupported()){ inputStream = new
	 * PushbackInputStream(inputStream, 8); }
	 */
	/*
	 * if(POIFSFileSystem.hasPOIFSHeader(inputStream)){
	 * 
	 * } if(POIXMLDocument.hasOOXMLHeader(inp)) { return new
	 * XSSFWorkbook(OPCPackage.open(inp)); }
	 */
