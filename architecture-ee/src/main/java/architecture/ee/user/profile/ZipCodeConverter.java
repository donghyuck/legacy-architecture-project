...
public class ZipCodeConverter extends StringConverter
{
    ...
    private static String zipCodeRegEx = AdminHelper.getApplicationProperty("validators.zipCode.lengthRegExp", "[\\-|0-9|a-z|A-Z| ]{2,15}");
    private static int minZipCodeLength = AdminHelper.getApplicationIntProperty("validators.zipCode.minLen", 2);
