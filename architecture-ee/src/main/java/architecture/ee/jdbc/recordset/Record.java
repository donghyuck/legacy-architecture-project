...
/**
 * Utility class for Recordset: represents a record inside a recordset <br>
...
public class Record implements Serializable {
    ...
    /**
     * Quick constructor to build a record given a HashMap with field|value
     * pairs
     * 
     * @param values
     *            Record values
    ...
    /**
     * Returns the field value (may be null). Throws exception if the field is
     * not defined in the record
     * 
     * @param fieldName
     *            Field name to retrieve value
     * @return
     * @throws Throwable
     */
	...
	if (!_record.containsKey(fieldName)) {
	    // patch 2010-03-10 - print current record field names to help
	    // detecting errors
     ...
     *            Field Name
     * @param value
     *            Value (Date, String, double, int, null)
     * @throws Throwable
     */
     ...
     * 
     * @return A reference to the recordset or null if no children recordset
     *         exists
     */
