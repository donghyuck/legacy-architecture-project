...
public class BootstrapTest {
     ...
     * 
     * I18nCountryDao dao =
     * Bootstrap.getBootstrapComponent(I18nCountryDao.class); int size =
     * dao.allCountryCount();
     * 
     * log.debug( "count:" + size);
     * 
     * for(I18nCountry country :dao.findAll(0, 50 ) ){ log.debug( ">>" + country
     * ) ; }
     * 
     * for(I18nCountry country :dao.findAll(50, 50 ) ){ log.debug( ">>>>" +
     * country ) ; }
     * 
     * }
     */
