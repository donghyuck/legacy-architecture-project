...
public class LicenseTest {
	...
	public void testPrivateKeyAndWriteLicense() {
		...
		License license = new License("APPLICATION ARCHITECTURE for JAVA", "ENTERPRISE", 2, 0, 1, "ANY", "ANY");
		//license.setID(20130614);
		license.setID(20160817);
		...
		license.setClient("www.podosw.com","PODO SOFTWARE");
