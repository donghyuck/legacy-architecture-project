...
public interface UserProvider {
     ...
     * @throws UserAlreadyExistsException
     */
    public User createUser(String username, String password, String name, String email, boolean nameVisible,
	    boolean emailVisible, Map proeprties) throws UserAlreadyExistsException;
    ...
    /**
     * startIndex 에서 시작하여 numResults 수 만큼의 사용자를 리턴한다. 기능을 지원하지 않는 경우
     * UnsupportedOperationException 이 리턴된다.
     * 
     * @param startIndex
     * @param numResults
     * @return
