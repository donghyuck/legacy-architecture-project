...
/**
 * A {@link EventExecutorFactory} that allows the {@link Executor} to be
 * produced with a custom {@link BlockingQueue}
 *
 * @since 2.1
 */
public abstract class AbstractEventExecutorFactory implements EventExecutorFactory {
    ...
    /**
     * @return a new {@link BlockingQueue BlockingQueue&lt;Runnable&gt;} for the
     *         construction of a new {@link Executor}
     */
