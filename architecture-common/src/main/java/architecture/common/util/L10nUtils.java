...
public class L10nUtils {
	...
	if (localizer == null) {
	    ...
	    if (localizer == null)
		throw new MissingResourceException((new StringBuilder()).append("Can't locate bundle for class '").append(key).append("'").toString(), key, "");
	}
	return localizer;
    }
	...
	if (keyToUse != null){
	    return new Localizer(ResourceBundle.getBundle(keyToUse.bundleName, locale, classloader));
	}
	return null;
    }
