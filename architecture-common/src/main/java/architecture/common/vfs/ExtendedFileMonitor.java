 ...
 */
public class ExtendedFileMonitor implements Runnable, FileMonitor
{
    private final static Log log = LogFactory.getLog(ExtendedFileMonitor.class);
    ...
    public ExtendedFileMonitor(final FileListener listener)
    {
    ...
    public List<FileObject> getMonitoredFileObjectList(){    	
    	List<FileObject> list = new ArrayList<FileObject>(monitorMap.values().size());    	
    ...
    private static class FileMonitorAgent
    {
        ...
        private final ExtendedFileMonitor fm;

        private boolean exists;
        private long timestamp;
        private Map children = null;

        private FileMonitorAgent(ExtendedFileMonitor fm, FileObject file)
        {
            this.fm = fm;
            this.file = file;
