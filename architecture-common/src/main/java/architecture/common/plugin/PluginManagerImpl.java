...
public class PluginManagerImpl implements PluginManager {
    ...
    public boolean isSetPluginDirectory(){
...
/*                if (customWebXML.exists()) {
    ...
    /**
     * Unloads a plugin. The {@link Plugin#destory()} method will be called and then
    ...
    public String getName(Plugin plugin) {
        ...
        if (name != null) {
            return null; // AdminConsole.getAdminText(name, pluginName);
        }
        else {
            return pluginName;
        }
