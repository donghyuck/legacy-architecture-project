...
public class FreeMarkerConfigurer extends FreeMarkerConfigurationFactory
	...
	if (this.configuration == null) {
		...
		if (home != null) {
		    ExtendedTemplateLoader templateLoader = new ExtendedTemplateLoader(home);
		    templateLoader.initialize();
		    // this.setPreTemplateLoaders(new TemplateLoader[]{
		    // templateLoader });
	...
	String location = configService.getApplicationProperty("view.html.customize.source.location", null);
	...
	return configService.getApplicationBooleanProperty("view.html.customize.enabled", false);
...
//	logger.debug(configService);
//	
//	String pathString = null ;	
//	try {
//	    pathString = configService.getLocalProperty(WebApplicatioinConstants.VIEW_FREEMARKER_SOURCE_LOCATION, null);
//	} catch (Exception e) {
//	}	
//	
