...
import architecture.ee.web.ui.navigator.displayer.MessageResourcesMenuDisplayer;
...
import architecture.ee.web.ui.navigator.menu.RolesPermissionsAdapter;
...
public class UseMenuDisplayerTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        if (repository == null) {
            repository = MenuRepositoryImpl.MENU_REPOSITORY_KEY;
        }
        ...
        MenuRepositoryImpl rep =
            (MenuRepositoryImpl) pageContext.findAttribute(this.repository);
