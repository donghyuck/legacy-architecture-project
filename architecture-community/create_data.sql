...
Insert into V2_SEQUENCER (SEQUENCER_ID,NAME,VALUE) values (4,'ROLE',8);
...
Insert into V2_SEQUENCER (SEQUENCER_ID,NAME,VALUE) values (34,'LOGO',1);
Insert into V2_SEQUENCER (SEQUENCER_ID,NAME,VALUE) values (35,'TIMELINE',1);
Insert into V2_SEQUENCER (SEQUENCER_ID,NAME,VALUE) values (37,'SOCIAL_CONNECT',1);
...
Insert into V2_ROLE (ROLE_ID,NAME,DESCRIPTION,MASK) values (4,'ROLE_COMPANY_ADMIN','회사 관리 ROLE',0);
Insert into V2_ROLE (ROLE_ID,NAME,DESCRIPTION,MASK) values (5,'ROLE_GROUP_ADMIN','그룹 관리 ROLE',0);
Insert into V2_ROLE (ROLE_ID,NAME,DESCRIPTION,MASK) values (6,'ROLE_USER_ADMIN','사용자 관리 ROLE',0);
Insert into V2_ROLE (ROLE_ID,NAME,DESCRIPTION,MASK) values (7,'ROLE_SITE_ADMIN','웹사이트 관리 ROLE',0);
