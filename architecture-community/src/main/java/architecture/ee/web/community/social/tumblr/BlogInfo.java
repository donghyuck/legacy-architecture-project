...
public class BlogInfo implements Serializable {
    ...
    private boolean primary; // – boolean: indicates if this is the user's
			     // primary blog
	...
	builder.append("queue=").append(queue).append(", ask=").append(ask).append(", askAnon=").append(askAnon)
		.append(", likes=").append(likes).append(", shareLikes=").append(shareLikes).append(", ");
	if (url != null)
	    builder.append("url=").append(url).append(", ");
	builder.append("primary=").append(primary).append(", admin=").append(admin).append(", followers=")
		.append(followers).append(", ");
	if (type != null)
	    builder.append("type=").append(type).append(", ");
	builder.append("drafts=").append(drafts).append(", messages=").append(messages)
		.append(", facebookOpengraphEnabled=").append(facebookOpengraphEnabled).append(", tweet=").append(tweet)
		.append(", facebook=").append(facebook).append("]");
