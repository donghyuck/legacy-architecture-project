...
public class Post implements Serializable {
	...
	builder.append("noteCount=").append(noteCount).append(", createdViaBookmarklet=").append(createdViaBookmarklet)
		.append(", createdViaMobile=").append(createdViaMobile).append(", ");
	if (sourceUrl != null)
	...
	builder.append("trackNumber=").append(trackNumber).append(", year=").append(year).append("]");
