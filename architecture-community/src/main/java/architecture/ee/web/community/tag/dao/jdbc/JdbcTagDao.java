...
public class JdbcTagDao extends ExtendedJdbcDaoSupport implements TagDao {
	...
	getExtendedJdbcTemplate().update(getBoundSql("ARCHITECTURE_COMMUNITY.INSERT_TAG").getSql(),
	...
	getExtendedJdbcTemplate().update(getBoundSql("ARCHITECTURE_COMMUNITY.DELETE_TAG").getSql(),
	...
	return getExtendedJdbcTemplate().queryForObject(getBoundSql("ARCHITECTURE_COMMUNITY.COUNT_TAG").getSql(),
	...
	return getExtendedJdbcTemplate().queryForObject(
		getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_CONTENT_TAG_BY_ID").getSql(), conentTagRowMapper,
		new SqlParameterValue(Types.NUMERIC, tagId));
    }
	...
	try {
	    return getExtendedJdbcTemplate().queryForObject(
		    getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_CONTENT_TAG_BY_NAME").getSql(), conentTagRowMapper,
