...
public class JdbcStreamsDao extends ExtendedJdbcDaoSupport implements StreamsDao {
	...
	public Photo mapRow(ResultSet rs, int rowNum) throws SQLException {
	    PhotoImpl photo = new PhotoImpl(rs.getString("EXTERNAL_ID"), rs.getLong("IMAGE_ID"), true,
		    rs.getLong("CREATOR"));
	...
	try {
	    Photo photo = getExtendedJdbcTemplate().queryForObject(
		    getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_STREAM_PHOTO_BY_ID").getSql(), photoMapper,
		    new SqlParameterValue(Types.VARCHAR, photoId));
	    return photo;
	...
	getExtendedJdbcTemplate().update(getBoundSql("ARCHITECTURE_COMMUNITY.DELETE_STREAM_PHOTO_BY_ID").getSql(),
		new SqlParameterValue(Types.VARCHAR, photo.getExternalId()));
    }

    public int getPhotoCount() {
	return getExtendedJdbcTemplate()
		.queryForInt(getBoundSql("ARCHITECTURE_COMMUNITY.COUNT_ALL_STREAM_PHOTO").getSql());
    }
	...
	return getExtendedJdbcTemplate()
		.queryForList(getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_ALL_STREAM_PHOTO_IDS").getSql(), String.class);
    }

    public List<String> getPhotoIds(int objectType) {
	return getExtendedJdbcTemplate().queryForList(
		getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_STREAM_PHOTO_IDS_BY_OBJECT_TYPE").getSql(), String.class,
		new SqlParameterValue(Types.NUMERIC, objectType), new SqlParameterValue(Types.NUMERIC, objectType));
    }
	...
	return getExtendedJdbcTemplate().queryForList(
		...
		String.class, new SqlParameterValue(Types.NUMERIC, objectType),
		new SqlParameterValue(Types.NUMERIC, objectId));
    }

    public List<String> getPhotoIds(int startIndex, int maxResults) {
	return getExtendedJdbcTemplate().queryScrollable(
		getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_ALL_STREAM_PHOTO_IDS").getSql(), startIndex, maxResults,
		new Object[0], new int[0], String.class);
    }

    public List<String> getPhotoIds(int objectType, int startIndex, int maxResults) {
	return getExtendedJdbcTemplate().queryScrollable(
		getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_STREAM_PHOTO_IDS_BY_OBJECT_TYPE").getSql(), startIndex,
		maxResults, new Object[] { objectType }, new int[] { Types.NUMERIC }, String.class);
    }

    public List<String> getPhotoIds(int objectType, long objectId, int startIndex, int maxResults) {
	return getExtendedJdbcTemplate().queryScrollable(
		getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_STREAM_PHOTO_IDS_BY_OBJECT_TYPE_AND_OBJECT_ID").getSql(),
		startIndex, maxResults, new Object[] { objectType, objectId },
		new int[] { Types.NUMERIC, Types.NUMERIC }, String.class);
    }

    public List<String> getPhotoIdsByRandom() {
	return getExtendedJdbcTemplate().queryForList(
		getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_ALL_STREAM_PHOTO_IDS_RANDOMLY").getSql(), String.class);
    }
	...
	return getExtendedJdbcTemplate().queryForList(
		getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_STREAM_PHOTO_IDS_BY_OBJECT_TYPE_AND_OBJECT_ID_RANDOMLY")
			.getSql(),
		String.class, new SqlParameterValue(Types.NUMERIC, objectType),
		new SqlParameterValue(Types.NUMERIC, objectId));
    }
	...
	return getExtendedJdbcTemplate().queryScrollable(
		getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_ALL_STREAM_PHOTO_IDS_RANDOMLY").getSql(), startIndex,
		maxResults, new Object[0], new int[0], String.class);
    }

    public List<String> getPhotoIdsByRandom(int objectType, int startIndex, int maxResults) {
	return getExtendedJdbcTemplate().queryScrollable(
		getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_STREAM_PHOTO_IDS_BY_OBJECT_TYPE_RANDOMLY").getSql(),
		startIndex, maxResults, new Object[] { objectType }, new int[] { Types.NUMERIC }, String.class);
    }
	...
	return getExtendedJdbcTemplate().queryForList(
		getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_STREAM_PHOTO_IDS_BY_IMAGE_ID").getSql(), String.class,
