...
class TweetDeserializer extends JsonDeserializer<Tweet> {
	...
	JsonNode languageCodeNode = metadataNode != null ? metadataNode.get("iso_language_code")
		: node.get("iso_language_code");
	...
	Long inReplyToStatusId = inReplyToStatusIdNode != null && !inReplyToStatusIdNode.isNull()
		? inReplyToStatusIdNode.asLong() : null;
	...
	Long inReplyUsersId = inReplyToUserIdNode != null && !inReplyToUserIdNode.isNull()
		? inReplyToUserIdNode.asLong() : null;
