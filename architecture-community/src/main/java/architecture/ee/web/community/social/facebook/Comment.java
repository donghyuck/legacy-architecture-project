...
public class Comment {
    ...
    /**
     * A list of references to users who liked this comment. May be null, as
     * Facebook often sends only a count of likes. In some cases (such as a
     * comment on a checkin) the likes will be a list of references.
     */
