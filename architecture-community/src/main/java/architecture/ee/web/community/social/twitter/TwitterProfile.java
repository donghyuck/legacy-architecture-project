...
public class TwitterProfile implements UserProfile {
    ...
    public TwitterProfile(long id, String screenName, String name, String url, String profileImageUrl,
     ...
     * http://support.twitter.com/groups/31-twitter-basics/topics/111-features/
    ...
    /**
     * The number of friends the user has (the number of users this user
     * follows).
     */
    ...
    /**
     * Whether or not a request has been sent by the authenticating user to
     * follow this user.
     */
    ...
    /**
     * Whether or not the user has selected to see all inline media from
     * everyone. If false, they will only see inline media from the users they
     * follow.
     */
	...
	if (sidebarFillColor != null ? !sidebarFillColor.equals(that.sidebarFillColor)
		: that.sidebarFillColor != null) {
	    return false;
	}
