...
public class JdbcTimelineDao extends ExtendedJdbcDaoSupport implements TimelineDao {
	...
	public Timeline mapRow(ResultSet rs, int rowNum) throws SQLException {
	    ...
	    DefaultMedia media = new DefaultMedia(rs.getString("MEDIA_URL"), rs.getString("MEDIA_THUMBNAIL_URL"),
		    rs.getString("MEDIA_CAPTION"), rs.getString("MEDIA_CREDIT"));
	...
	return getExtendedJdbcTemplate().query(
		getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_TIMELINE_IDS_BY_OBJECT_TYPE_AND_OBJECT_ID_WITH_DATE_DESC")
			.getSql(),
		new RowMapper<Long>() {
