...
public class JdbcProfileDao extends ExtendedJdbcDaoSupport implements ProfileDao {
	...
	try {
	    ...
	    getExtendedJdbcTemplate().update(getBoundSql("ARCHITECTURE_COMMUNITY.RESET_PROFILE_IMAGE_BY_USER").getSql(),
	...
	return getExtendedJdbcTemplate().queryForList(
		getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_PROFILE_IMAGE_IDS_BY_USER").getSql(), Long.class,
	...
	if (getExtendedJdbcTemplate().getDatabaseType() == DatabaseType.oracle) {
	    getExtendedJdbcTemplate().update(
		    ...
		    new SqlParameterValue(Types.NUMERIC, image.getProfileImageId()));
	    getExtendedJdbcTemplate().update(getBoundSql("ARCHITECTURE_COMMUNITY.UPDATE_PROFILE_IMAGE_DATA").getSql(),
	    ...
	    getExtendedJdbcTemplate().update(getBoundSql("ARCHITECTURE_COMMUNITY.INSERT_PROFILE_IMAGE_DATA").getSql(),
		    new SqlParameterValue(Types.NUMERIC, image.getProfileImageId()), new SqlParameterValue(Types.BLOB,
