...
public class UserInfo implements UserProfile {
	...
	if (defaultPostFormat != null)
	    builder.append("defaultPostFormat=").append(defaultPostFormat).append(", ");
	builder.append("likes=").append(likes).append(", following=").append(following).append(", ");
	if (blogInfos != null)
