...
public class JdbcWebSiteDao extends ExtendedJdbcDaoSupport implements WebSiteDao {
	...
	try {
	    WebSite site = getExtendedJdbcTemplate().queryForObject(
		    getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_WEBSITE_BY_ID").getSql(), siteMapper,
	...
	try {
	    return getExtendedJdbcTemplate().queryForObject(
		    getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_WEBSITE_BY_NAME").getSql(), siteMapper,
	...
	try {
	    return getExtendedJdbcTemplate().queryForObject(
		    getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_WEBSITE_BY_URL").getSql(), siteMapper,
	...
	return getExtendedJdbcTemplate().queryForList(
		getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_COMPANY_WEBSITE_IDS").getSql(), Long.class,
		new SqlParameterValue(Types.NUMERIC, companyId));
    }

    public List<Long> findWebSitesByUrl(String url) {
	return getExtendedJdbcTemplate().queryForList(
		getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_COMPANY_WEBSITE_IDS_BY_URL").getSql(), Long.class,
		new SqlParameterValue(Types.VARCHAR, '%' + url + '%'));
    }

    public List<Long> findWebSitesByName(String name) {
	return getExtendedJdbcTemplate().queryForList(
		getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_COMPANY_WEBSITE_IDS_BY_NAME").getSql(), Long.class,
		new SqlParameterValue(Types.VARCHAR, '%' + name + '%'));
    }
	...
	try {
	    WebPage page = getExtendedJdbcTemplate().queryForObject(
		    getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_WEBPAGE_BY_NAME").getSql(), pageMapper,
	...
	try {
	    WebPage page = getExtendedJdbcTemplate().queryForObject(
		    getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_WEBPAGE_BY_ID").getSql(), pageMapper,
	...
	return getExtendedJdbcTemplate().queryForList(
		getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_WEBPAGE_IDS_BY_WEBSITE").getSql(), Long.class,
		new SqlParameterValue(Types.NUMERIC, websiteId));
    }
	...
	return getExtendedJdbcTemplate().queryScrollable(
		getBoundSql("ARCHITECTURE_COMMUNITY.SELECT_WEBPAGE_IDS_BY_WEBSITE").getSql(), startIndex, maxResults,
