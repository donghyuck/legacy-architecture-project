...
public class TumblrTest {
	...
	TumblrServiceProvider p = new TumblrServiceProvider("VdE7COcqx3c8qiXg45AowMPausYVvYDpBSIrx1jI6gPj1X5V8T",
		"SILFKJbnYTuFLWVhCnKiD1wpd4T6ahVC0HXTemu1AqT3X7iL0r",
		"http://222.122.63.146/community/tumblr-callback.do");

	// Token t =
	// p.getTokenWithCallbackReturns("2yLGSX6dPq0VannTTUGHxdiFaMeAerDQqDFiLWwz9sABlJFYwL",
	// "vEgN8WZdinCJ0szJNHcXMP0gGosZro4H84uR3r5WT8u1hmbfj0");

	// Token accessToken =
	// p.getOAuthService()..getAccessToken(getRequestToken(), new
	// Verifier(accessKey));

	/*
	 * Token accessToken = p.getOAuthService().getAccessToken( new
	 * Token("vCL5Xw5GtYGF8eBZZeSgPKpKbkEZ9atq16wsru1hYorK8WMBV3",
	 * "4HXUP4fOIP9o5XjZJUAsh5M1a4etSaOUBRJBpTlRJ0LTyKTDVM" ), new
	 * Verifier("vEgN8WZdinCJ0szJNHcXMP0gGosZro4H84uR3r5WT8u1hmbfj0"));
	 */
	...
	// Token t2 =
	// p.get//p.getTokenWithCallbackReturns("FS0hwAHSILvfTPzMJwIULXAthInoUmzYJfd860X4LReGsYlgav",
	// "kplZgRDbtRuPEwXSKZR6XsE5nPoi3Ho3iiwJjIzpG0QWwVD7jt#_=_");

	/*
	 * Token t2 = new
	 * Token("FS0hwAHSILvfTPzMJwIULXAthInoUmzYJfd860X4LReGsYlgav",
	 * "ZHLbT2fZtmpVTt3HSVt9CNYx8snayiGkJZP3dK2S9wacdYW1Us"); Token
	 * accessToken = p.getOAuthService().getAccessToken(t, new
	 * Verifier("kplZgRDbtRuPEwXSKZR6XsE5nPoi3Ho3iiwJjIzpG0QWwVD7jt#_=_"));
	 * 
	 * System.out.println("==============================");
